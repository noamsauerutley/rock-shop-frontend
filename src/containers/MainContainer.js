        ...
        return (
            <>
                ...
                <Switch>
                    ...
                    <Route path="/cart" >
                        <CartContainer removeItemFromCart={this.props.removeItemFromCart} resetCart={this.props.resetCart} clearCart={this.props.clearCart} token={this.props.token} loggedInUserId={this.props.loggedInUserId} total={this.props.total} currentCart={this.props.currentCart}/>
                    </Route>
